const domdom = {
  ...
  document: { 
     getElementById: () => ({ getContext: () => null, clientWidth: 800, clientHeight: 600 }),
     addEventListener: () => {}
  },
  window: { addEventListener: () => {}, navigator: { userAgent: "Node" } }
};
global.window = domdom.window;
global.document = domdom.document;
global.navigator = domdom.navigator;
// @ts-nocheck
